...
```{r}
t1 <- clean_trial_traits[[1]]$dbo_LINE_LINE_ID
t2 <- clean_trial_traits[[2]]$dbo_LINE_LINE_ID
t3 <- clean_trial_traits[[3]]$dbo_LINE_LINE_ID
t4 <- clean_trial_traits[[4]]$dbo_LINE_LINE_ID
```

```{r}
test <- Reduce(intersect, list(t4, t3))
```
