...
line_traits <- read.csv('C:\\Users\\Meso\\Documents\\BMVT\\LINE_NORMAL.csv', header = T, stringsAsFactors = F)
plot_traits_non_lodging <- read.csv('C:\\Users\\Meso\\Documents\\BMVT\\PLOT_NORMAL_NON_LODGING.csv', header = T, stringsAsFactors = F)
